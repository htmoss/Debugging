...
/**
 * User: sameer Date: 16/05/2013 Time: 10:03
 */
public class Meeting implements Comparable<Meeting> {
    ...
    public int compareTo(Meeting that) {
        ...
        Interval toCompareMeetingInterval = new Interval(that.getStartTime().toDateTimeToday(),
                that.getFinishTime().toDateTimeToday());
